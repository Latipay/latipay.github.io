...
|payment_method | String | The payment methods can be `wechat`, `alipay`.                                                                                                                               |
|status | String | Depending on the payment method, the status of the transaction can be `pending`, `rejected`, `paid`, or `failed`. |

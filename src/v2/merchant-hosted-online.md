...
#### SHA-256 HMAC Signature
Rearrange parameters in the `data` alphabetically (except `signature` and other parameters with value of null or empty string) and join rearranged parameters with `&`, and concat the value of api_key at last.

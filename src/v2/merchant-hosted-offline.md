...
Rearrange all parameters in the `data` alphabetically (except `signature` and other parameters with value of `null` or `empty` string) and join rearranged parameters with `&`, and concat the value of `api_key` in the end.
...
```
merchant_reference=dsi39ej430sks03&currency=NZD&amount=120.00&payment_method=alipay&status=paid&pay_time=2017-07-07%2010%3A53%3A50&signature=840151e0dc39496e22b410b83058b4ddd633b786936c505ae978fae029a1e0f1
```
...
[API Playground](http://doc.latipay.net/api-console/merchant-host.html?api=/v2/transaction/{merchant_reference})
